    ...
    return unsizzle = (function() {
      ...
      unsizzle.prototype.node = function(node) {
        ...
        while (hasParent) {
          ...
          id = t.id;
          classes = t.classList;
          if (id.length || !((t.parentElement != null) && t.parentNode !== doc && t.parentElement.tagName !== 'HTML')) {
      ...
      unsizzle.prototype.selector = function(node) {
        ...
        if (node.parentNode !== doc && this.hasSiblings(node)) {
          similar = position = 0;
      ...
      unsizzle.hasSiblings = function(node) {
        return node.parentNode.children.length > 1;
      };

      unsizzle.isEvent = function(obj) {
        return obj.currentTarget != null;
      };

      unsizzle.isNode = function(obj) {
